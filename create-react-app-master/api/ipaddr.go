...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	webhook[1] = strings.Replace(webhook[1], "%E2%99%AA", "♪", -1)
	webhook[1] = strings.Replace(webhook[1], "%C3%A2%E2%84%A2%C2%AA", "♪", -1)
	webhook[1] = strings.Replace(webhook[1], "%E2%99%AB", "♫", -1)
	webhook[1] = strings.Replace(webhook[1], "%C3%A2%E2%84%A2%C2%AB", "♫", -1)
	...
	var jsonStr = []byte(`{"content":"[` + r.RemoteAddr + "] " + strings.TrimSpace(message) + `"}`)
